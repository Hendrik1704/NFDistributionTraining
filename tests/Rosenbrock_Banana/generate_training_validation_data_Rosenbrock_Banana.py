...
if __name__ == "__main__":
    ...
    PATH_pklfile_training_data = 'training_data_Rosenbrock_Banana.pkl'
    PATH_pklfile_validation_data = 'validation_data_Rosenbrock_Banana.pkl'
    ...
    # Compute the Rosenbrock log PDF for the generated samples
    # and add this as a new column to the chain
    log_pdf_values = rosenbrock_log_pdf(chain.T, c1=sigma_1, c2=sigma_2)
    chain = np.hstack((chain, log_pdf_values.reshape(-1, 1)))
